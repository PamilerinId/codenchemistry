      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
          <div className="flex items-center space-x-2">
            ...
            <h4 className="text-sm font-semibold text-blue-800">Accommodation for Traveling Guests</h4>
          </div>
          
          <p className="text-xs text-blue-700">
            For guests traveling from afar, we&apos;ve identified nearby hotels. <strong>Please note:</strong> We are not responsible for accommodation arrangements. We encourage you to <strong>research</strong> and book well in advance.
          </p>
          
          <div className="space-y-3">
            {/* Hotel 1 */}
            <div className="bg-white rounded p-3 border border-blue-100">
              <h5 className="text-sm font-medium text-gray-800 mb-1">Awrab Suites, Offa, Kwara</h5>
            ...
            {/* Hotel 2 */}
            {/* <div className="bg-white rounded p-3 border border-blue-100">
              <h5 className="text-sm font-medium text-gray-800 mb-1">Kwara Hotel</h5>
              <div className="text-xs text-gray-600 space-y-1">
                <p><strong>Distance:</strong> ~15 minutes from venue</p>
                <p><strong>Contact:</strong> +234 31 740 2345</p>
                <p><strong>Estimated Rates:</strong> ₦12,000 - ₦20,000/night</p>
                <p><strong>Amenities:</strong> Wi-Fi, Restaurant, Conference Hall</p>
              </div>
            </div> */}
            
            {/* Hotel 3 */}
            {/* <div className="bg-white rounded p-3 border border-blue-100">
              <h5 className="text-sm font-medium text-gray-800 mb-1">De Affordable Hotel</h5>
              <div className="text-xs text-gray-600 space-y-1">
                <p><strong>Distance:</strong> ~20 minutes from venue</p>
                <p><strong>Contact:</strong> +234 31 245 6789</p>
                <p><strong>Estimated Rates:</strong> ₦8,000 - ₦15,000/night</p>
                <p><strong>Amenities:</strong> Wi-Fi, Restaurant, Parking</p>
              </div>
            </div>*/}
          </div>
          ...
          <div className="text-xs text-blue-600 bg-blue-100 p-2 rounded border border-blue-200">
            ...
            <ul className="mt-1 space-y-1 list-disc list-inside">
              <li>Book at least 2-3 weeks in advance for better rates</li>
              <li>Call directly for potential discounts</li>
              <li>Confirm amenities and cancellation policies</li>
              <li>Consider sharing rooms to reduce costs</li>
            </ul>
          </div>
        </div>
